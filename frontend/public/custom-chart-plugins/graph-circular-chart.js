...
function GraphCircularChart({ dHelper }) {
  return {
    config: {
      datas: [
        {
    ...
    getSeries(
      ...
      const [rotateLabel] = this.getArrStyleValueByGroup(
        ['rotateLabel'],
        styleConfigs,
        'label',
      );
